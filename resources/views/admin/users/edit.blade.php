...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-12">
          <h1 class="m-0 text-center text-dark">Փոփոխել Տվյալները</h1>
        </div>
        </div>
      </div>
    </div>
    <div>
      <form method="POST" action="{{ route('user_update') }}" class="container-sm">
        @csrf
        ...
        <div class="form-group mx-auto col-lg-6 col-md-7">
          <label for="ConfirmPassword">Կրկնել Գաղտնաբառը</label>
        ...
        <div class="form-group mx-auto col-lg-6 col-md-7">
          <button type="submit" class="btn btn-outline-success col-12">Հաստատել Փոփոխությունը</button>
        </div>
      </form>
    </div>    
    <!-- /.content -->
